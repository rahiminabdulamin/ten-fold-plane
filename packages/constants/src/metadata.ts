...
export const SITE_NAME = "Ten-Fold | Project management";
export const SITE_TITLE = "Ten-Fold | Project management";
export const SITE_DESCRIPTION =
  "Project management for teams that want clarity and momentum.";
