...
grep -Fq 'body > div[class*="grain335"] > div > div {' "$grist_css_path"
grep -Fq '@import url("/grist/form-branding.css");' "$grist_css_path"
grep -Fq 'background-color: #fff !important;' "$grist_css_path"
grep -Fq 'body > div[class*="grain335"] > div > div > div[class*="grain337"],' "$grist_css_path"
grep -Fq 'body > div[class*="grain335"] > div > footer {' "$grist_css_path"
grep -Fq 'background-color: #000 !important;' "$grist_css_path"
grep -Fq 'handle /grist/form-branding.css {' "$proxy_path"
grep -Fq 'uri /api/v1/internal/grist/form-branding/' "$proxy_path"
