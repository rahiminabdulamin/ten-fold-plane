...
export const TopNavPowerK = observer(() => {
  ...
  return (
    <div ref={containerRef} className="relative w-full">
      <div
        className={cn("relative z-30 flex w-full items-center transition-all duration-300 ease-in-out sm:w-[364px]", {
          "sm:w-[554px]": isOpen,
        })}
      >
        <div
      ...
      <div
        className={cn(
          "shadow-lg fixed top-11 left-2 z-20 flex w-[calc(100vw-1rem)] flex-col overflow-hidden rounded-md border border-subtle bg-surface-1 px-0 pt-10 transition-all duration-300 ease-in-out sm:absolute sm:-top-[6px] sm:left-1/2 sm:w-auto sm:-translate-x-1/2",
          {
            "max-h-[80vh] opacity-100 sm:w-[574px]": isOpen,
