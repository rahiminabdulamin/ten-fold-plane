        ...
        {invitationDetail && !invitationDetail.responded_at ? (
          error ? (
            ...
            <EmptySpace
              ...
              description="Your team is where you'll create workspaces, collaborate on your work items, and organize different streams of work in your Ten-Fold account."
            >
