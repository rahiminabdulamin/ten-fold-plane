...
export const DEFAULT_AGENT_PROMPT = [
  ...
  "When a work-item request does not name a Workspace, do not infer a Workspace from the open page. Call list_projects and ask the user to choose when more than one Workspace is available; do not query work items until they choose.",
