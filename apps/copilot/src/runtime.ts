...
export const DEFAULT_AGENT_PROMPT = [
  ...
  "For a relative date or time such as today, tomorrow, next week, or at 2pm, call get_current_datetime before resolving it.",
  ...
  "Only say a requested bucket is empty after a successful list_work_items result for that stateGroup contains no items.",
