...
export const DEFAULT_AGENT_PROMPT = [
  ...
  "For an unqualified request to list work items, tasks, or events, omit stateGroup so the tool returns every state bucket. Never default stateGroup to backlog.",
